...
async def generate_text(
    ...
    return await GenerationService(session).create("text", payload.model_dump(), background_tasks)
...
async def generate_constructor(
    ...
    return await GenerationService(session).create("constructor", payload.model_dump(), background_tasks)
...
async def generate_emotion(
    ...
    return await GenerationService(session).create("emotion", payload.model_dump(), background_tasks)
...
async def generate_reference(
    ...
    return await GenerationService(session).create("reference", payload.model_dump(), background_tasks)
...
async def generate_ambient(
    ...
    return await GenerationService(session).create("ambient", payload.model_dump(), background_tasks)
