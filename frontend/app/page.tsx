...
export default function Home() {
  ...
  return (
    <div className="space-y-8">
      <section className="glass overflow-hidden rounded-[2.5rem] p-8 md:p-12">
        <div className="max-w-4xl">
          <p className="text-sm uppercase tracking-[0.4em] text-cyan">{t("home.badge")}</p>
          <h1 className="mt-5 text-5xl font-semibold tracking-tight md:text-7xl">{t("home.title")}</h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            {t("home.description")}
          </p>
          <Link href="/generate/text" className="mt-8 inline-flex items-center gap-3 rounded-2xl bg-white px-6 py-4 font-semibold text-ink">
